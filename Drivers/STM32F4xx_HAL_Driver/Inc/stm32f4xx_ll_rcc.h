...
#define LL_RCC_SAI1_A_CLKSOURCE_PLL                                                                                    \
  (uint32_t)(RCC_DCKCFGR_SAI1ASRC | (RCC_DCKCFGR_SAI1ASRC_1 >> 16)) /*!< PLL clock used as SAI1 block A clock source   \
                                                                     */
...
#define LL_RCC_SAI1_B_CLKSOURCE_PLL                                                                                    \
  (uint32_t)(RCC_DCKCFGR_SAI1BSRC | (RCC_DCKCFGR_SAI1BSRC_1 >> 16)) /*!< PLL clock used as SAI1 block B clock source   \
                                                                     */
